// entities/round/model/round-validation.ts
//
// Moved from game/round-validation.ts as part of the entities/round
// slice -- see ../../README.md. `game/round-validation.ts` re-exports
// everything here as a temporary bridge so existing consumers keep
// working unchanged (see that file's own comment).
