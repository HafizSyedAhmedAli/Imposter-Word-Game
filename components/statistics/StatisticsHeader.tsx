...
/**
 * Same header shell as SettingsHeader/CustomWordsHeader (back arrow
 * left, centered icon/title/subtitle, live connection indicator right)
 * -- goes back to "/" since Statistics is only ever reached from the
 * Home screen's STATISTICS card.
 */
