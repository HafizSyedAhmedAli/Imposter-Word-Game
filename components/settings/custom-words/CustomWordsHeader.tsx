 ...
 * centered icon/title/subtitle, live connection indicator right), but
 * goes back to /settings rather than "/" -- this screen is only ever
 * reached from there.
 */
export default function CustomWordsHeader() {
  return (
    <header className="flex items-start justify-between gap-3">
      ...
      <div className="flex flex-1 flex-col items-center px-1 text-center">
        ...
        <p className="mt-1 max-w-[22rem] text-sm text-iw-violet-300 sm:text-base">
          Your own secret words, saved on this device.
        </p>
      </div>
