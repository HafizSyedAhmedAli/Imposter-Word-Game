...
// Minimal placeholder for Screen 6 (Discussion) so Screen 5 has somewhere
// real to navigate to once every player has seen their role. Discussion,
// clues, voting, and results are a separate task -- not implemented here
// (see Pass the Phone spec, sections 28 + 90).
